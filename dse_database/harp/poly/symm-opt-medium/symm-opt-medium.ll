...
define dso_local void @kernel_symm(double %alpha, double %beta, [240 x double]* %C, [200 x double]* %A, [240 x double]* %B) #0 {
entry:
...
for.body3:                                        ; preds = %for.cond1
  %2 = load [240 x double]*, [240 x double]** %B.addr, align 8
  %3 = load i32, i32* %i, align 4
  %idxprom = sext i32 %3 to i64
  %arrayidx = getelementptr inbounds [240 x double], [240 x double]* %2, i64 %idxprom
  %4 = load i32, i32* %j, align 4
  %idxprom4 = sext i32 %4 to i64
  %arrayidx5 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx, i64 0, i64 %idxprom4
...
if.then:                                          ; preds = %for.body8
  ...
  %11 = load [200 x double]*, [200 x double]** %A.addr, align 8
  %12 = load i32, i32* %i, align 4
  %idxprom10 = sext i32 %12 to i64
  %arrayidx11 = getelementptr inbounds [200 x double], [200 x double]* %11, i64 %idxprom10
  %13 = load i32, i32* %k, align 4
  %idxprom12 = sext i32 %13 to i64
  %arrayidx13 = getelementptr inbounds [200 x double], [200 x double]* %arrayidx11, i64 0, i64 %idxprom12
  %14 = load double, double* %arrayidx13, align 8
  %mul14 = fmul double %mul, %14
  %15 = load [240 x double]*, [240 x double]** %C.addr, align 8
  %16 = load i32, i32* %k, align 4
  %idxprom15 = sext i32 %16 to i64
  %arrayidx16 = getelementptr inbounds [240 x double], [240 x double]* %15, i64 %idxprom15
  %17 = load i32, i32* %j, align 4
  %idxprom17 = sext i32 %17 to i64
  %arrayidx18 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx16, i64 0, i64 %idxprom17
...
if.then23:                                        ; preds = %for.body21
  %23 = load [240 x double]*, [240 x double]** %B.addr, align 8
  %24 = load i32, i32* %k, align 4
  %idxprom24 = sext i32 %24 to i64
  %arrayidx25 = getelementptr inbounds [240 x double], [240 x double]* %23, i64 %idxprom24
  %25 = load i32, i32* %j, align 4
  %idxprom26 = sext i32 %25 to i64
  %arrayidx27 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx25, i64 0, i64 %idxprom26
  %26 = load double, double* %arrayidx27, align 8
  %27 = load [200 x double]*, [200 x double]** %A.addr, align 8
  %28 = load i32, i32* %i, align 4
  %idxprom28 = sext i32 %28 to i64
  %arrayidx29 = getelementptr inbounds [200 x double], [200 x double]* %27, i64 %idxprom28
  %29 = load i32, i32* %k, align 4
  %idxprom30 = sext i32 %29 to i64
  %arrayidx31 = getelementptr inbounds [200 x double], [200 x double]* %arrayidx29, i64 0, i64 %idxprom30
...
for.end37:                                        ; preds = %for.cond19
  ...
  %34 = load [240 x double]*, [240 x double]** %C.addr, align 8
  %35 = load i32, i32* %i, align 4
  %idxprom38 = sext i32 %35 to i64
  %arrayidx39 = getelementptr inbounds [240 x double], [240 x double]* %34, i64 %idxprom38
  %36 = load i32, i32* %j, align 4
  %idxprom40 = sext i32 %36 to i64
  %arrayidx41 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx39, i64 0, i64 %idxprom40
  %37 = load double, double* %arrayidx41, align 8
  %mul42 = fmul double %33, %37
  %38 = load double, double* %alpha.addr, align 8
  %39 = load [240 x double]*, [240 x double]** %B.addr, align 8
  %40 = load i32, i32* %i, align 4
  %idxprom43 = sext i32 %40 to i64
  %arrayidx44 = getelementptr inbounds [240 x double], [240 x double]* %39, i64 %idxprom43
  ...
  %43 = load [200 x double]*, [200 x double]** %A.addr, align 8
  %44 = load i32, i32* %i, align 4
  %idxprom48 = sext i32 %44 to i64
  %arrayidx49 = getelementptr inbounds [200 x double], [200 x double]* %43, i64 %idxprom48
  ...
  %49 = load [240 x double]*, [240 x double]** %C.addr, align 8
  %50 = load i32, i32* %i, align 4
  %idxprom56 = sext i32 %50 to i64
  %arrayidx57 = getelementptr inbounds [240 x double], [240 x double]* %49, i64 %idxprom56
  %51 = load i32, i32* %j, align 4
  %idxprom58 = sext i32 %51 to i64
  %arrayidx59 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx57, i64 0, i64 %idxprom58
