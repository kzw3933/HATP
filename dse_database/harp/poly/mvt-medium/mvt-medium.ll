...
define dso_local void @kernel_mvt(double* %x1, double* %x2, double* %y_1, double* %y_2, [400 x double]* %A) #0 {
entry:
...
for.body3:                                        ; preds = %for.cond1
  %2 = load [400 x double]*, [400 x double]** %A.addr, align 8
  %3 = load i32, i32* %i, align 4
  %idxprom = sext i32 %3 to i64
  %arrayidx = getelementptr inbounds [400 x double], [400 x double]* %2, i64 %idxprom
  %4 = load i32, i32* %j, align 4
  %idxprom4 = sext i32 %4 to i64
  %arrayidx5 = getelementptr inbounds [400 x double], [400 x double]* %arrayidx, i64 0, i64 %idxprom4
...
for.cond16:                                       ; preds = %for.inc29, %for.body15
  ...
  %cmp17 = icmp slt i32 %15, 400
  br i1 %cmp17, label %for.body18, label %for.end31

for.body18:                                       ; preds = %for.cond16
  %16 = load [400 x double]*, [400 x double]** %A.addr, align 8
  %17 = load i32, i32* %j, align 4
  %idxprom19 = sext i32 %17 to i64
  %arrayidx20 = getelementptr inbounds [400 x double], [400 x double]* %16, i64 %idxprom19
  %18 = load i32, i32* %i, align 4
  %idxprom21 = sext i32 %18 to i64
  %arrayidx22 = getelementptr inbounds [400 x double], [400 x double]* %arrayidx20, i64 0, i64 %idxprom21
