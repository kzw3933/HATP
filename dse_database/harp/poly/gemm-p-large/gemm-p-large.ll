...
define dso_local void @kernel_gemm(i32 %ni, i32 %nj, i32 %nk, double %alpha, double %beta, [220 x double]* %C, [240 x double]* %A, [220 x double]* %B) #0 {
entry:
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %cmp2 = icmp slt i32 %1, 220
  br i1 %cmp2, label %for.body3, label %for.end

for.body3:                                        ; preds = %for.cond1
  %2 = load double, double* %beta.addr, align 8
  %3 = load [220 x double]*, [220 x double]** %C.addr, align 8
  %4 = load i32, i32* %i, align 4
  %idxprom = sext i32 %4 to i64
  %arrayidx = getelementptr inbounds [220 x double], [220 x double]* %3, i64 %idxprom
  %5 = load i32, i32* %j, align 4
  %idxprom4 = sext i32 %5 to i64
  %arrayidx5 = getelementptr inbounds [220 x double], [220 x double]* %arrayidx, i64 0, i64 %idxprom4
...
for.cond9:                                        ; preds = %for.inc26, %for.body8
  ...
  %cmp10 = icmp slt i32 %9, 220
  br i1 %cmp10, label %for.body11, label %for.end28

for.body11:                                       ; preds = %for.cond9
  %10 = load double, double* %alpha.addr, align 8
  %11 = load [240 x double]*, [240 x double]** %A.addr, align 8
  %12 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %12 to i64
  %arrayidx13 = getelementptr inbounds [240 x double], [240 x double]* %11, i64 %idxprom12
  %13 = load i32, i32* %k, align 4
  %idxprom14 = sext i32 %13 to i64
  %arrayidx15 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx13, i64 0, i64 %idxprom14
  %14 = load double, double* %arrayidx15, align 8
  %mul16 = fmul double %10, %14
  %15 = load [220 x double]*, [220 x double]** %B.addr, align 8
  %16 = load i32, i32* %k, align 4
  %idxprom17 = sext i32 %16 to i64
  %arrayidx18 = getelementptr inbounds [220 x double], [220 x double]* %15, i64 %idxprom17
  %17 = load i32, i32* %j, align 4
  %idxprom19 = sext i32 %17 to i64
  %arrayidx20 = getelementptr inbounds [220 x double], [220 x double]* %arrayidx18, i64 0, i64 %idxprom19
  %18 = load double, double* %arrayidx20, align 8
  %mul21 = fmul double %mul16, %18
  %19 = load [220 x double]*, [220 x double]** %C.addr, align 8
  %20 = load i32, i32* %i, align 4
  %idxprom22 = sext i32 %20 to i64
  %arrayidx23 = getelementptr inbounds [220 x double], [220 x double]* %19, i64 %idxprom22
  %21 = load i32, i32* %j, align 4
  %idxprom24 = sext i32 %21 to i64
  %arrayidx25 = getelementptr inbounds [220 x double], [220 x double]* %arrayidx23, i64 0, i64 %idxprom24
