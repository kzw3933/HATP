...
define dso_local void @kernel_fdtd_2d(i32 %tmax, i32 %nx, i32 %ny, [240 x double]* %ex, [240 x double]* %ey, [240 x double]* %hz, double* %_fict_) #0 {
entry:
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = load [240 x double]*, [240 x double]** %ey.addr, align 8
  %arrayidx4 = getelementptr inbounds [240 x double], [240 x double]* %5, i64 0
  %6 = load i32, i32* %j, align 4
  %idxprom5 = sext i32 %6 to i64
  %arrayidx6 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx4, i64 0, i64 %idxprom5
...
for.cond10:                                       ; preds = %for.inc31, %for.body9
  ...
  %cmp11 = icmp slt i32 %9, 240
  br i1 %cmp11, label %for.body12, label %for.end33

for.body12:                                       ; preds = %for.cond10
  %10 = load [240 x double]*, [240 x double]** %ey.addr, align 8
  %11 = load i32, i32* %i, align 4
  %idxprom13 = sext i32 %11 to i64
  %arrayidx14 = getelementptr inbounds [240 x double], [240 x double]* %10, i64 %idxprom13
  %12 = load i32, i32* %j, align 4
  %idxprom15 = sext i32 %12 to i64
  %arrayidx16 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx14, i64 0, i64 %idxprom15
  %13 = load double, double* %arrayidx16, align 8
  %14 = load [240 x double]*, [240 x double]** %hz.addr, align 8
  %15 = load i32, i32* %i, align 4
  %idxprom17 = sext i32 %15 to i64
  %arrayidx18 = getelementptr inbounds [240 x double], [240 x double]* %14, i64 %idxprom17
  %16 = load i32, i32* %j, align 4
  %idxprom19 = sext i32 %16 to i64
  %arrayidx20 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx18, i64 0, i64 %idxprom19
  %17 = load double, double* %arrayidx20, align 8
  %18 = load [240 x double]*, [240 x double]** %hz.addr, align 8
  %19 = load i32, i32* %i, align 4
  %sub = sub nsw i32 %19, 1
  %idxprom21 = sext i32 %sub to i64
  %arrayidx22 = getelementptr inbounds [240 x double], [240 x double]* %18, i64 %idxprom21
  %20 = load i32, i32* %j, align 4
  %idxprom23 = sext i32 %20 to i64
  %arrayidx24 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx22, i64 0, i64 %idxprom23
  ...
  %22 = load [240 x double]*, [240 x double]** %ey.addr, align 8
  %23 = load i32, i32* %i, align 4
  %idxprom27 = sext i32 %23 to i64
  %arrayidx28 = getelementptr inbounds [240 x double], [240 x double]* %22, i64 %idxprom27
...
for.cond40:                                       ; preds = %for.inc63, %for.body39
  ...
  %cmp41 = icmp slt i32 %28, 240
  br i1 %cmp41, label %for.body42, label %for.end65

for.body42:                                       ; preds = %for.cond40
  %29 = load [240 x double]*, [240 x double]** %ex.addr, align 8
  %30 = load i32, i32* %i, align 4
  %idxprom43 = sext i32 %30 to i64
  %arrayidx44 = getelementptr inbounds [240 x double], [240 x double]* %29, i64 %idxprom43
  %31 = load i32, i32* %j, align 4
  %idxprom45 = sext i32 %31 to i64
  %arrayidx46 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx44, i64 0, i64 %idxprom45
  %32 = load double, double* %arrayidx46, align 8
  %33 = load [240 x double]*, [240 x double]** %hz.addr, align 8
  %34 = load i32, i32* %i, align 4
  %idxprom47 = sext i32 %34 to i64
  %arrayidx48 = getelementptr inbounds [240 x double], [240 x double]* %33, i64 %idxprom47
  %35 = load i32, i32* %j, align 4
  %idxprom49 = sext i32 %35 to i64
  %arrayidx50 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx48, i64 0, i64 %idxprom49
  %36 = load double, double* %arrayidx50, align 8
  %37 = load [240 x double]*, [240 x double]** %hz.addr, align 8
  %38 = load i32, i32* %i, align 4
  %idxprom51 = sext i32 %38 to i64
  %arrayidx52 = getelementptr inbounds [240 x double], [240 x double]* %37, i64 %idxprom51
  %39 = load i32, i32* %j, align 4
  %sub53 = sub nsw i32 %39, 1
  %idxprom54 = sext i32 %sub53 to i64
  %arrayidx55 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx52, i64 0, i64 %idxprom54
  ...
  %41 = load [240 x double]*, [240 x double]** %ex.addr, align 8
  %42 = load i32, i32* %i, align 4
  %idxprom59 = sext i32 %42 to i64
  %arrayidx60 = getelementptr inbounds [240 x double], [240 x double]* %41, i64 %idxprom59
  %43 = load i32, i32* %j, align 4
  %idxprom61 = sext i32 %43 to i64
  %arrayidx62 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx60, i64 0, i64 %idxprom61
...
for.cond72:                                       ; preds = %for.inc105, %for.body71
  ...
  %cmp73 = icmp slt i32 %47, 239
  br i1 %cmp73, label %for.body74, label %for.end107

for.body74:                                       ; preds = %for.cond72
  %48 = load [240 x double]*, [240 x double]** %hz.addr, align 8
  %49 = load i32, i32* %i, align 4
  %idxprom75 = sext i32 %49 to i64
  %arrayidx76 = getelementptr inbounds [240 x double], [240 x double]* %48, i64 %idxprom75
  %50 = load i32, i32* %j, align 4
  %idxprom77 = sext i32 %50 to i64
  %arrayidx78 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx76, i64 0, i64 %idxprom77
  %51 = load double, double* %arrayidx78, align 8
  %52 = load [240 x double]*, [240 x double]** %ex.addr, align 8
  %53 = load i32, i32* %i, align 4
  %idxprom79 = sext i32 %53 to i64
  %arrayidx80 = getelementptr inbounds [240 x double], [240 x double]* %52, i64 %idxprom79
  %54 = load i32, i32* %j, align 4
  %add = add nsw i32 %54, 1
  %idxprom81 = sext i32 %add to i64
  %arrayidx82 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx80, i64 0, i64 %idxprom81
  %55 = load double, double* %arrayidx82, align 8
  %56 = load [240 x double]*, [240 x double]** %ex.addr, align 8
  %57 = load i32, i32* %i, align 4
  %idxprom83 = sext i32 %57 to i64
  %arrayidx84 = getelementptr inbounds [240 x double], [240 x double]* %56, i64 %idxprom83
  %58 = load i32, i32* %j, align 4
  %idxprom85 = sext i32 %58 to i64
  %arrayidx86 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx84, i64 0, i64 %idxprom85
  %59 = load double, double* %arrayidx86, align 8
  %sub87 = fsub double %55, %59
  %60 = load [240 x double]*, [240 x double]** %ey.addr, align 8
  %61 = load i32, i32* %i, align 4
  %add88 = add nsw i32 %61, 1
  %idxprom89 = sext i32 %add88 to i64
  %arrayidx90 = getelementptr inbounds [240 x double], [240 x double]* %60, i64 %idxprom89
  %62 = load i32, i32* %j, align 4
  %idxprom91 = sext i32 %62 to i64
  %arrayidx92 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx90, i64 0, i64 %idxprom91
  %63 = load double, double* %arrayidx92, align 8
  %add93 = fadd double %sub87, %63
  %64 = load [240 x double]*, [240 x double]** %ey.addr, align 8
  %65 = load i32, i32* %i, align 4
  %idxprom94 = sext i32 %65 to i64
  %arrayidx95 = getelementptr inbounds [240 x double], [240 x double]* %64, i64 %idxprom94
  %66 = load i32, i32* %j, align 4
  %idxprom96 = sext i32 %66 to i64
  %arrayidx97 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx95, i64 0, i64 %idxprom96
  ...
  %68 = load [240 x double]*, [240 x double]** %hz.addr, align 8
  %69 = load i32, i32* %i, align 4
  %idxprom101 = sext i32 %69 to i64
  %arrayidx102 = getelementptr inbounds [240 x double], [240 x double]* %68, i64 %idxprom101
  %70 = load i32, i32* %j, align 4
  %idxprom103 = sext i32 %70 to i64
  %arrayidx104 = getelementptr inbounds [240 x double], [240 x double]* %arrayidx102, i64 0, i64 %idxprom103
