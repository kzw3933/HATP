...
define dso_local void @kernel_atax([410 x double]* %A, double* %x, double* %y, double* %tmp) #0 {
entry:
...
for.cond6:                                        ; preds = %for.inc17, %for.body3
  ...
  %cmp7 = icmp slt i32 %7, 410
  br i1 %cmp7, label %for.body8, label %for.end19

for.body8:                                        ; preds = %for.cond6
  %8 = load [410 x double]*, [410 x double]** %A.addr, align 8
  %9 = load i32, i32* %i, align 4
  %idxprom9 = sext i32 %9 to i64
  %arrayidx10 = getelementptr inbounds [410 x double], [410 x double]* %8, i64 %idxprom9
  %10 = load i32, i32* %j, align 4
  %idxprom11 = sext i32 %10 to i64
  %arrayidx12 = getelementptr inbounds [410 x double], [410 x double]* %arrayidx10, i64 0, i64 %idxprom11
...
for.cond20:                                       ; preds = %for.inc33, %for.end19
  ...
  %cmp21 = icmp slt i32 %19, 410
  br i1 %cmp21, label %for.body22, label %for.end35

for.body22:                                       ; preds = %for.cond20
  %20 = load [410 x double]*, [410 x double]** %A.addr, align 8
  %21 = load i32, i32* %i, align 4
  %idxprom23 = sext i32 %21 to i64
  %arrayidx24 = getelementptr inbounds [410 x double], [410 x double]* %20, i64 %idxprom23
  %22 = load i32, i32* %j, align 4
  %idxprom25 = sext i32 %22 to i64
  %arrayidx26 = getelementptr inbounds [410 x double], [410 x double]* %arrayidx24, i64 0, i64 %idxprom25
